...
## なぜこのアプリを作ったか
### 【背景】
前職で勤務、情報共有時の抜け漏れや正確に伝わらないといった課題がありました。<br>
情報共有のミスによってご利用者様に迷惑をかけてしまうということもあり、どうにか解決できないかと考えたことがきっかけです。
...
8月31日現在（10日間使用)<br>
- 情報共有のミス0件<br>
- 投稿写真の枚数が少なく、うまく活用できているかは怪しい<br>
...
### 【投稿枚数が少ない】
1日の投稿に対する写真が1〜2枚であることが多く、抜け漏れを防ぐという課題の対策になっていないと感じるため<br>
共有する情報量を増やせるようアプリの修正や使用方法の見直しをしていきたいです。

### 【JavaScriptの理解が浅く、未実装の機能がある】
javaScriptを使用した写真を投稿時にトリミングする機能の実装が中断しているため、理解を深め完了させたいです。<br>
